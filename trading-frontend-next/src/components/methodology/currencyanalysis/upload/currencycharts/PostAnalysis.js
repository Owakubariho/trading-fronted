...
const PostAnalysis = () => {
  ...
  useEffect(() => {
    const savedImages = localStorage.getItem("currency");
    if (savedImages) {
      try {
  ...
  useEffect(() => {
    localStorage.setItem("currency", JSON.stringify(images));
  }, [images]);
      ...
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-8">
          <h1 className="text-3xl font-extrabold text-gray-900 mb-2">
            currency Chart Gallery
          </h1>
          <p className="text-lg text-gray-600">
            Upload and view yourcurrency charts
          </p>
        </div>
          ...
          >
            <div className="flex flex-col items-center justify-center space-y-2">
              ...
              <p className="text-gray-600 font-medium">
                {isUploading
                  ? "Uploading..."
                  : "Uploadcurrency charts (candlestick, line, bar)"}
              </p>

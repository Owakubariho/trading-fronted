      ...
      <div className="flex flex-col min-h-screen">
        ...
        <div className="flex flex-grow pt-16">
          ...
          <div className="w-1/4 bg-gray-200 p-4">
            ...
            />
            <Dropdown
              label="Commitment of traders(comm and noncomm netpositioncharts)"
              links={cotchartsnetposition1}
            />
            <Dropdown
              label="Commitment of traders(specComm diffcharts)"
              links={cotchartSpeccommdiff}
            />
            <Dropdown
              label="Commitment of traders(index charts)"
              links={cotindex}
            />
            <Dropdown
              label="Commitment of traders(line-charts)"
              links={cotchartline}
            />
            <Dropdown

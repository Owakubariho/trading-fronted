...
export const Gbp3 = () => {
  ...
  const BRITISHPOUND = data.find((item) => item.Asset === "BRITISH POUND");
  ...
  // }
  const commercialIndex = BRITISHPOUND?.CommercialWilliamsIndex;
  console.log(commercialIndex); // "71.41"
  const nonCommercialIndex = BRITISHPOUND?.NonCommercialWilliamsIndex;

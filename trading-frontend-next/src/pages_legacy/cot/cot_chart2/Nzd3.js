...
export const Nzd3 = () => {
  ...
  const NZDOLLAR = data.find((item) => item.Asset === "NZ DOLLAR");
  console.log(NZDOLLAR);
  // Output:
  // {
  ...
  // }
  const commercialIndex = NZDOLLAR?.CommercialWilliamsIndex;
  console.log(commercialIndex); // "71.41"
  const nonCommercialIndex = NZDOLLAR?.NonCommercialWilliamsIndex;

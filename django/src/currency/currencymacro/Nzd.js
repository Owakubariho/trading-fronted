      ...
      <table className="min-w-full bg-white border border-gray-300 mb-8">
        <thead>
          <tr>
            ...
            <th className="px-4 py-2 border-b">Highest</th>
            <th className="px-4 py-2 border-b">Lowest</th>
        ...
        <tbody>
          {currencies.map((currency, index) => (
            <tr key={index} className="hover:bg-gray-100">
              ...
              <td className="px-4 py-2 border-b">{currency.Highest}</td>
              <td className="px-4 py-2 border-b">{currency.Lowest}</td>

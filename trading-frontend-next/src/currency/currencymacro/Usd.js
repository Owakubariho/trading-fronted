...
const Usd = () => {
  ...
  return (
    <div className="p-6 bg-gray-100 min-h-screen">
      <h1 className="text-3xl font-bold mb-6 text-center text-blue-700"> Fundermental Analysis</h1>
      ...
      {itemAtIndexSix && (
        <div className="mb-8">
          <h2 className="text-2xl font-semibold mb-4 text-center  text-blue-700">Summation of Key Fundamental Data</h2>
        ...
        <div className="relative h-96 mb-8">
          <Bar
            ...
            options={{
              ...
              plugins: {
                title: {
                  text: "FUNDERMENTAL STRENGTH METER (ALL MAJOR CURRENCIES)",
                  display: true,
                },
              },
              scales: {
